package com.github.com.eiAlex.SaudeBusca.service;
...
import com.github.com.eiAlex.SaudeBusca.TrackingActivity;
import com.github.com.eiAlex.SaudeBusca.domain.MessageEB;
import com.github.com.eiAlex.SaudeBusca.domain.User;
    ...
    // INNER CLASS
        private class MyAsyncTask extends AsyncTask<JobParameters, Void, Void>{
            ...
            protected Void doInBackground(JobParameters... params) {
                ...
                HttpConnection.getSetDataWeb("https://saudebusca.000webhostapp.com/location-api/package/ctrl/CtrlMap.php",
                        "send-map-coords",
                        mMessageEB);
